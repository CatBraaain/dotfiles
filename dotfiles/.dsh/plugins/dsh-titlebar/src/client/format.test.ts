...
import { buildTitle, SPINNER_FRAMES, SPINNER_INTERVAL_MS, spinnerFrame, splitMarkedTitle, WAITING_MARK } from './format'
...
describe('spinnerFrame', () => {
    ...
    it('wraps around after the last frame', () => {
        ...
        assert.equal(spinnerFrame(SPINNER_INTERVAL_MS * (SPINNER_FRAMES.length + 1)), SPINNER_FRAMES[1])
    })
